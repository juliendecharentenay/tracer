...
export function useAppState() {
  const { data: svgData, addPoint, addPath, updatePoint, removePath } = useSvgData()
  ...
  return { state, setImageBase64, setCropResult, setCanvasParameters, addPoint, addPath, updatePoint, removePath }
}
